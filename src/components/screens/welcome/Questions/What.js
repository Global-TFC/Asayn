...
function What() {
  return (
    <div>
      <button className='content'>Knolsort is a free video sharing website that makes it easy to watch
    ...
    of the video tutorials on our website are actually YouTube videos!</button>
    </div>
  )
}
